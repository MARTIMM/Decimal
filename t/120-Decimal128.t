...
subtest 'init decimal128 nummerator/denominator', {
  my Decimal::D128 $d128 .= new( 2, 4);
  isa-ok $d128, Decimal::D128;
...
subtest 'init decimal128 with Num and others', {
  my Decimal::D128 $d128 .= new(:num(1.34e4));
...
#-------------------------------------------------------------------------------
subtest 'd128 bcd', {
  my Decimal::D128 $d128 .= new(:str<234>);
...
subtest 'd128 dpd', {
  ...
  is-deeply $d128.bcd2dpd($d128.bcd8('94589800')),
